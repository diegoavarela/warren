...
**Generated**: 2025-07-30T18:50:35.187Z
**Company**: VTEX Solutions SRL
**Currency**: ARS
**Query**: make a bar chart with the ebitda from january to may, also add a line as second source with the ebitda margin
...
```json
{
  ...
  "dataAvailability": {
    ...
    "lastUpdated": "2025-07-30T18:50:10.542Z"
  },
  "financialSummary": {
    "revenue": {
      "total": "ARS 246K",
