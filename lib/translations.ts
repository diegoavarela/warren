export const translations = {
  es: {
    ...
    'config.fields.monthlyGeneration.description': 'Efectivo neto generado/consumido cada mes (Entradas - Salidas)',
  ...
  en: {
    ...
    'config.metadata.description': 'Update currency, locale, and unit settings',
