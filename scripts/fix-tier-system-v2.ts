...
async function fixTierSystem() {
  try {
    ...
    // Step 2: Update existing organizations to new tier values FIRST
    console.log('2️⃣  Mapping existing organizations to new tier system...');
    ...
    // Step 3: Now add new constraint with correct values
    console.log('3️⃣  Adding new tier constraint...');
    await sql`
      ALTER TABLE organizations 
