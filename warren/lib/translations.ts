export const translations = {
  es: {
    ...
    'quickbooks.configure': 'Configurar QuickBooks',
    'quickbooks.title': 'Integración con QuickBooks',
    'quickbooks.settings': 'Configuración de QuickBooks',
    'quickbooks.description': 'Configura las credenciales de la API de QuickBooks para tu organización',
    'quickbooks.api_credentials': 'Credenciales de la API',
    'quickbooks.environment': 'Entorno',
    'quickbooks.sandbox': 'Sandbox',
    'quickbooks.production': 'Producción',
    'quickbooks.client_id': 'Client ID',
    'quickbooks.client_secret': 'Client Secret',
    'quickbooks.redirect_uri': 'URI de Redirección',
    'quickbooks.save_credentials': 'Guardar Credenciales',
    'quickbooks.test_connection': 'Probar Conexión',
    'quickbooks.connect': 'Conectar a QB',
    'quickbooks.connecting': 'Conectando...',
    'quickbooks.connected': 'Conectado a QuickBooks',
    'quickbooks.not_connected': 'No Conectado a QB',
    'quickbooks.disconnect': 'Desconectar',
    'quickbooks.view_data': 'Ver Datos de P&L',
    'quickbooks.connection_instructions': 'Haz clic en el botón de abajo para conectar tu empresa a QuickBooks. Serás redirigido a QuickBooks para autorizar el acceso.',
    'quickbooks.disconnect_confirmation': 'Desconectar detendrá la sincronización automática de datos. Puedes reconectarte en cualquier momento.',
    'quickbooks.realm_id': 'ID del Reino: {realmId}',
    'quickbooks.success.connected': '¡Conectado exitosamente a QuickBooks!',
    'quickbooks.success.disconnected': 'Desconectado exitosamente de QuickBooks',
    'quickbooks.success.credentials_saved': '¡Configuración guardada exitosamente!',
    'quickbooks.connection_successful': '¡Prueba de conexión exitosa!',
    'quickbooks.connection_failed': 'Prueba de conexión fallida',
    'quickbooks.errors.connection_failed': 'Error al iniciar la conexión',
    'quickbooks.errors.disconnection_failed': 'Error al desconectar',
    'quickbooks.errors.invalid_credentials': 'Error al cargar la configuración',
  ...
  en: {
    ...
    'config.tabs.periods': 'Period Mapping',
    ...
    // Period Mapping
    'periodMapping.title': 'Period Mapping Configuration',
    'periodMapping.description': 'Define exactly what each Excel column represents. No more guessing!',
    'periodMapping.autoDetect': 'Auto-detect',
    'periodMapping.table.excelColumn': 'Excel Column',
    'periodMapping.table.periodType': 'Period Type',
    'periodMapping.table.year': 'Year',
    'periodMapping.table.monthQuarter': 'Month/Quarter',
    'periodMapping.table.displayLabel': 'Display Label',
    'periodMapping.table.preview': 'Preview',
    'periodMapping.type.monthly': 'Monthly',
    'periodMapping.type.quarterly': 'Quarterly',
    'periodMapping.type.yearly': 'Yearly',
    'periodMapping.type.custom': 'Custom',
    'periodMapping.excluded': 'Excluded',
    'periodMapping.notMapped': 'Not mapped',
    'periodMapping.customPlaceholder': 'Custom period name',
    'periodMapping.customPeriod': 'Custom Period',
    'periodMapping.invalidPeriod': 'Invalid Period',
    'periodMapping.includeColumn': 'Click to include this column',
    'periodMapping.excludeColumn': 'Click to exclude this column (for percentages, totals, etc.)',
    'periodMapping.validation.duplicatePeriods': 'Duplicate periods detected',
    'periodMapping.validation.yearRequired': 'Year is required',
    'periodMapping.validation.monthRequired': 'Valid month (1-12) is required for monthly periods',
    'periodMapping.validation.quarterRequired': 'Valid quarter (1-4) is required for quarterly periods',
    'periodMapping.validation.customRequired': 'Custom value is required for custom periods',
    'periodMapping.validation.success': 'Period mapping is valid! columns successfully mapped.',
    'periodMapping.help.title': 'How Period Mapping Works',
    'periodMapping.help.point1': 'Each Excel column is explicitly mapped to a specific period',
    'periodMapping.help.point2': 'No more guessing or interpreting Excel date formats',
    'periodMapping.help.point3': 'The dashboard will show exactly what you configure here',
    'periodMapping.help.point4': 'Supports monthly, quarterly, yearly, or custom periods',
    'periodMapping.help.point5': 'Click column headers to exclude columns that are not data (percentages, totals, etc.)',
    'periodMapping.months.january': 'January',
    'periodMapping.months.february': 'February',
    'periodMapping.months.march': 'March',
    'periodMapping.months.april': 'April',
    'periodMapping.months.may': 'May',
    'periodMapping.months.june': 'June',
    'periodMapping.months.july': 'July',
    'periodMapping.months.august': 'August',
    'periodMapping.months.september': 'September',
    'periodMapping.months.october': 'October',
    'periodMapping.months.november': 'November',
    'periodMapping.months.december': 'December',
    'periodMapping.months.short.jan': 'Jan',
    'periodMapping.months.short.feb': 'Feb',
    'periodMapping.months.short.mar': 'Mar',
    'periodMapping.months.short.apr': 'Apr',
    'periodMapping.months.short.may': 'May',
    'periodMapping.months.short.jun': 'Jun',
    'periodMapping.months.short.jul': 'Jul',
    'periodMapping.months.short.aug': 'Aug',
    'periodMapping.months.short.sep': 'Sep',
    'periodMapping.months.short.oct': 'Oct',
    'periodMapping.months.short.nov': 'Nov',
    'periodMapping.months.short.dec': 'Dec',
    ...
    // QuickBooks Integration
    'quickbooks.configure': 'Configure QuickBooks',
    'quickbooks.title': 'QuickBooks Integration',
    'quickbooks.settings': 'QuickBooks Settings',
    'quickbooks.description': 'Configure QuickBooks API credentials for your organization',
    'quickbooks.api_credentials': 'API Credentials',
    'quickbooks.environment': 'Environment',
    'quickbooks.sandbox': 'Sandbox',
    'quickbooks.production': 'Production',
    'quickbooks.client_id': 'Client ID',
    'quickbooks.client_secret': 'Client Secret',
    'quickbooks.redirect_uri': 'Redirect URI',
    'quickbooks.save_credentials': 'Save Credentials',
    'quickbooks.test_connection': 'Test Connection',
    'quickbooks.connect': 'Connect to QB',
    'quickbooks.connecting': 'Connecting...',
    'quickbooks.connected': 'Connected to QuickBooks',
    'quickbooks.not_connected': 'QB Not Connected',
    'quickbooks.disconnect': 'Disconnect',
    'quickbooks.view_data': 'View P&L Data',
    'quickbooks.connection_instructions': 'Click the button below to connect your company to QuickBooks. You\'ll be redirected to QuickBooks to authorize access.',
    'quickbooks.disconnect_confirmation': 'Disconnecting will stop automatic data synchronization. You can reconnect at any time.',
    'quickbooks.realm_id': 'Realm ID: {realmId}',
    'quickbooks.success.connected': 'Successfully connected to QuickBooks!',
    'quickbooks.success.disconnected': 'Successfully disconnected from QuickBooks',
    'quickbooks.success.credentials_saved': 'Settings saved successfully!',
    'quickbooks.connection_successful': 'Connection test successful!',
    'quickbooks.connection_failed': 'Connection test failed',
    'quickbooks.errors.connection_failed': 'Failed to initiate connection',
    'quickbooks.errors.disconnection_failed': 'Failed to disconnect',
    'quickbooks.errors.invalid_credentials': 'Error loading settings',
  }
};
