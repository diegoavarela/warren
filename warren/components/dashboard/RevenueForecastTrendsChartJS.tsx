...
interface RevenueForecastTrendsProps {
  historicalData: any[];
  forecastData: any[];
...
export function RevenueForecastTrendsChartJS({ 
  historicalData,
  forecastData,
  ...
  const { chartData, forecastStats } = useMemo(() => {
    ...
    const chartJSData = {
      ...
      datasets: [
        {
          label: t('forecast.actualRevenue'),
      ...
      <div className="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <HelpIcon 
              topic={helpTopics['dashboard.revenueTrends']} 
              size="sm" 
